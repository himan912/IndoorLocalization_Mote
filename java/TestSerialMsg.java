...
public class TestSerialMsg extends net.tinyos.message.Message {
    ...
    public int get_source() {
        return (int)getSIntBEElement(offsetBits_counter(), 16);
    }
     ...
     */
    public int get_rssi() {
        return (int)getSIntBEElement(offsetBits_counter()+16, 16);
    }
     ...
     */
    public int get_x() {
        return (int)getSIntBEElement(offsetBits_counter()+32, 16);
    }
     ...
     */
    public int get_y() {
        return (int)getSIntBEElement(offsetBits_counter()+48, 16);
    }
